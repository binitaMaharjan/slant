            ...
            <div className="row">
                <div className="col-sm-12 side_nav">
                    ...
                    <ul className="nav nav-pills nav-stacked">
                        <li><Link to="/analytics" className="active"><img src="images/Analytics.png"/>&#8195; Analytics</Link></li>
                        <li><Link to="/review"><img src="images/Reviews.png"/>&#8195; Reviews <span className="badge">12</span></Link></li>
